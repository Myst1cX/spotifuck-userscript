...
// @updateURL    https://raw.githubusercontent.com/Myst1cX/spotifuck-userscript/main/spotifuck-v1.user.js
// @downloadURL  https://raw.githubusercontent.com/Myst1cX/spotifuck-userscript/main/spotifuck-v1.user.js
// ==/UserScript==
...
(function() {
    ...
    (function trackStatusReporter() {
        ...
        setInterval(() => {
            ...
            if (currState !== lastState) {
                ...
                // Replace with your actual communication bridge if needed:
                // AndBridge.playerStatus(JSON.stringify(values));
                console.log('[Spotifuck] PlayerStatus:', values);
            } else if (position !== null) {
                // AndBridge.trackPosition(position);
            }
        }, 1000);
    })();
    ...
    // Spotify loads audio ads with audio/mpeg; we override fetch to return silent audio blob instead.
    (function silentAudioAdBlocker() {
        const originalFetch = window.fetch;
        const silentAudioBlob = new Blob([new Uint8Array(44)], { type: 'audio/wav' }); // empty WAV header, silence
