...
public class C0314y extends ImageView {

    /* renamed from: f  reason: collision with root package name */
    public final C0140b f4328f;

    /* renamed from: g  reason: collision with root package name */
    public final C0312x f4329g;
    ...
    public final boolean hasOverlappingRendering() {
        if ((this.f4329g.f4322a.getBackground() instanceof RippleDrawable) || !super.hasOverlappingRendering()) {
            return false;
        }
        return true;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C0312x xVar = this.f4329g;
        if (!(xVar == null || drawable == null || this.f4330h)) {
    ...
    public C0314y(Context context, AttributeSet attributeSet, int i) {
